...
7. Fichiers Beat Studio : le fichier canonique est
   `C:\Users\gwada\Downloads\Beat_Studio_CDJ_MOBILE_alpha25.html`
   (= alpha24 + ordre septième/suspension, flag `_CHORD_SUS_ORDER_V1` ;
   alpha24 = alpha23 + qualité PMDI normalisée, flag `_PMDI_QUALITY_NORM_V1` ;
